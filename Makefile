...
IMPLS = ada awk bash basic c chuck clojure coffee common-lisp cpp crystal cs d dart \
	...
	guile haskell haxe hy io java java8 js julia kotlin livescript logo lua make mal \
...
java8_STEP_TO_PROG =   java8/target/classes/com/github/kanaka/mal/steps/$($(1)).class
